...
* The [`cubical` Agda library] by Anders Mörtberg, Felix Cherubini, Evan Cavallo, Axel Ljungström and others
* The [1lab] by Amélia Liao, Astra Kolomatskaia, Reed Mullanix and others
* The [Cubical Agda tutorial] at the [HoTTEST Summer School 2022] by Anders Mörtberg
* The [`cubicaltt` tutorial] by Anders Mörtberg
* mvrnote: agda-unimath
...
[1lab]: https://1lab.dev/
[Cubical Agda tutorial]: https://github.com/martinescardo/HoTTEST-Summer-School/tree/main/Agda/Cubical
[HoTTEST Summer School 2022]: https://www.uwo.ca/math/faculty/kapulkin/seminars/hottest_summer_school_2022.html
[`cubicaltt` tutorial]: https://github.com/mortberg/cubicaltt/tree/master/lectures
[Cubical Synthetic Homotopy Theory]: https://staff.math.su.se/anders.mortberg/papers/cubicalsynthetic.pdf
...
The website is built using [mdbook], together with some build scripts
adapted from the [agda-unimath] project. Inline code is linked to its
definition by a method adapted from the [1lab].
